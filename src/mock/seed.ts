  ...
  return {
    ...
    proProfiles: [
      ...
      },
      {
        ...
        documentPlaceholders: ["Electrical worker registration card"],
        completedJobs: 74,
    ...
    bookings: [
      {
        id: "booking_seed_amy_aircon",
        requestId: "req_1",
        quoteId: "quote_1",
        customerId: "user_customer_amy",
        proId: "user_pro_chan",
        status: "scheduled",
        scheduledDate: "2026-05-04T10:00:00.000Z",
        estimatedDurationMinutes: 120,
        createdAt: now,
        updatedAt: now,
        statusEventIds: ["book_event_seed_amy_aircon_accepted"],
      },
    ],
    bookingStatusEvents: [
      {
        id: "book_event_seed_amy_aircon_accepted",
        bookingId: "booking_seed_amy_aircon",
        status: "scheduled",
        note: "Booking confirmed and added to the customer calendar.",
        createdAt: now,
        createdByUserId: "user_customer_amy",
      },
    ],
    notifications: [
      {
    ...
    adminNotes: [
      {
        ...
        body: "Waiting for address verification document.",
        createdAt: now,
