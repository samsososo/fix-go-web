...
export default async function SignupPage({
  ...
  const initialRole = (await searchParams).role === "pro" ? "pro" : "customer";
  ...
  return (
    <div className="content-wrap py-10">
      <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="hidden overflow-hidden bg-white/74 lg:block">
          ...
          <CardContent className="space-y-5 p-8">
            ...
            <h2 className="font-display text-4xl font-extrabold">
              {locale === "en"
                ? "Start your repair or find your next job"
                : "搵師傅，或者搵工作"}
            </h2>
            <p className="text-sm leading-7 text-muted">
              {locale === "en"
                ? "Sign up as a customer to request repair quotes, or as a professional to browse suitable work."
                : "選擇客戶身份，提交維修需求；選擇師傅身份，尋找合適工作。"}
            </p>
